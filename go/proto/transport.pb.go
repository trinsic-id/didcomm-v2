...
import (
	keys "github.com/trinsic-id/okapi/keys"
	pbmse "github.com/trinsic-id/okapi/pbmse"
...
type PackRequest struct {
	...
	Mode           pbmse.EncryptionMode      `protobuf:"varint,5,opt,name=mode,proto3,enum=pbmse.EncryptionMode" json:"mode,omitempty"`
	Algorithm      pbmse.EncryptionAlgorithm `protobuf:"varint,6,opt,name=algorithm,proto3,enum=pbmse.EncryptionAlgorithm" json:"algorithm,omitempty"`
}
...
var file_transport_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x42, 0x4f, 0x0a, 0x0f, 0x4f, 0x6b, 0x61, 0x70, 0x69, 0x2e, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x70, 0x6f, 0x72, 0x74, 0x42, 0x03, 0x41, 0x50, 0x49, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x72, 0x69, 0x6e, 0x73, 0x69, 0x63, 0x2d, 0x69,
	0x64, 0x2f, 0x6f, 0x6b, 0x61, 0x70, 0x69, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72,
	0x74, 0xaa, 0x02, 0x0f, 0x4f, 0x6b, 0x61, 0x70, 0x69, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x70,
...
var file_transport_proto_goTypes = []interface{}{
	...
	(*keys.JsonWebKey)(nil),        // 9: okapi.keys.JsonWebKey
	(*pbmse.SignedMessage)(nil),    // 10: pbmse.SignedMessage
	(pbmse.EncryptionMode)(0),      // 11: pbmse.EncryptionMode
	(pbmse.EncryptionAlgorithm)(0), // 12: pbmse.EncryptionAlgorithm
	(*pbmse.EncryptedMessage)(nil), // 13: pbmse.EncryptedMessage
}
